...
cache_dir = os.environ.get("DSCTM_DAICWOZ_CACHE", "artifacts/cache/daicwoz_egemaps88")
ds, manifest = build_daicwoz88(root=root, cache_dir=cache_dir)
...
r = run_daic_headline(ds, manifest, seeds=(0, 1, 2, 3, 4), cfg=cfg,
                      out_name="daicwoz_headline_egemaps88_masked.json")
