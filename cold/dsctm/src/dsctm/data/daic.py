...
DAIC_ROOT_DEFAULT = "/media/adii/adissd/phd/dsctm-resubmission/dataset/daicwoz"
...
def build_daic(root=DAIC_ROOT_DEFAULT, T=T_MAX, cache_dir=None, limit=None):
    ...
    ds._lengths = np.asarray(lengths)
    manifest = {
...
DAICWOZ_ROOT_DEFAULT = "/media/adii/adissd/phd/dsctm-resubmission/dataset/DAIC-WOZ"
